...
import ProjectCards from "../sub";
import Link from "next/link";

const Projects = () => {
  const projectsData = [
    {
      src: "/projects/Dynamic Resume Builder.png",
    ...
    },
    {
      ...
      path: "https://classassignment-3.vercel.app/",
    },
    {
      ...
      path: "https://asadullahshafique-devunity.vercel.app/",
    },
    {
      ...
      path: "https://figma-assign-5.vercel.app/",
    },
    {
      src: "/projects/skill-enhancer.png",
      title: "My first project using snaity",
      description:
        "This is my first project using sanity built with Next.js and Tailwind CSS",
      path: "https://skill-enhancer.vercel.app/",
    },
    {
