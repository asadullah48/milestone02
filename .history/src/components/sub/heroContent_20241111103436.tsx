    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
        ...
        >
          ...
          like Next.js. Through continuous learning and practical experience, I am dedicated to improving user experiences and addressing real-world challenges with innovative web solutions.
        </motion.p>
        {/* Download CV Button */}
