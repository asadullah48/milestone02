    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
        ...
        >
          ...
          and aspiring <span className="font-bold">CERTIFIED CLOUD APPLIED GENERATIVE AI ENGINEER.</span> My portfolio highlights a diverse array of projects crafted with cutting-edge technologies like Next.js. Through continuous learning and practical experience, I am dedicated to improving user experiences and addressing real-world challenges with innovative web solutions.
        </motion.p>
        {/* Download CV Button */}
